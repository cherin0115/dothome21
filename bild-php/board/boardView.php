                ...
                <div class="container">
                    <div class="boardView-container">
                        <div class="board-wrap">
                            ...
                            <button class="btn_submit3" type="submit" value="저장하기"><a href="board.php">목록보기</a></button>
                            <button class="btn_submit3" type="submit" value="수정하기"><a href="boardModify.php?boardID=<?=$_GET['boardID']?>">수정하기</a></button>
                            <button class="btn_submit3" type="submit" value="삭제하기"><a href="boardRemove.php?boardID=<?=$_GET['boardID']?>" onclick="confirm('정말 삭제하시겠습니까?')">삭제하기</a></button></button>
                        </div>
                    </div>
                </div>
            </article>
